    ...
    return (
      ...
      <div className="px-8 py-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <div>
                  ...
                  <Link href="https://www.nextsunpower.com/privacy-policy"><h6 className="text-white transition-colors duration-300 dark:hover:text-blue-400 hover:font-bold">Privacy Policy</h6></Link>
                      ...
                      <a href="https://nextsunpower.com/sitemap.xml" className="text-white transition-colors duration-300 dark:hover:text-blue-400 hover:font-bold">Sitemap</a>
                  </div>
              </div>
              ...
              <div className="mb-5">
                  ...
                  <a href="#" className="text-white transition-colors duration-300 dark:hover:text-blue-400 hover:font-bold">Digimach 10 LLC</a>
                     ...
                     <Link href="https://www.facebook.com/people/nextsunpower/61575434679519/"><RiFacebookBoxLine className="text-white text-3xl" /></Link>
          ...
          <div className="flex flex-col items-center py-2 w-full rounded-xl mt-5 bg-white justify-between px-2 sm:flex-row">
              ...
              <p className="mt-4 text-sm text-center text-gray-800 text-xs lg:text-left lg:text-sm sm:mt-0">©Copyright Nexts Sun Power 2025. <br className="block lg:hidden"/> All Rights Reserved.</p>
          </div>
      </div>
  </div>
    )
