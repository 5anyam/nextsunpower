  ...
  export default function PrivacyPolicyPage() {
    return (
      <main className="max-w-4xl mt-24 lg:mt-0 mx-auto px-4 py-12 text-gray-800">
        ...
        <p className="mb-4">
          Under our children’s policy, children under the age of fifteen should not use saynopest. We do not intentionally collect any personal information from persons under the age of 15 years. Please get in touch with us at www.nextsunpower.com if you are a parent or guardian and think that your child has given us any personal information by mistake.
        </p>
